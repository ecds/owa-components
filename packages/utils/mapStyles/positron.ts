...
export const positron: StyleSpecification = {
  version: 8,
  name: "OWA",
  ...
  layers: [
...

    {
      ...
      layout: {
        ...
        "text-anchor": [
          "step",
          ["zoom"],
          ["match", ["get", "class"], "aerialway", "center", "bottom"],
          16,
          [
            "match",
            ["get", "class"],
    ...
    },
    {
      ...
      layout: {
        ...
        "text-anchor": [
          "step",
          ["zoom"],
          ["match", ["get", "class"], "town", "left", "center"],
          8,
          "center",
        ],
        "text-field": "{name:latin}\n{name:nonlatin}",
    ...
    },
    {
      ...
      layout: {
        ...
        "text-anchor": [
          "step",
          ["zoom"],
          ["match", ["get", "class"], "city", "left", "center"],
          8,
          "center",
        ],
        "text-field": "{name:latin}\n{name:nonlatin}",
    ...
    },
    {
      ...
      layout: {
        ...
        "text-size": ["interpolate", ["exponential", 1], ["zoom"], 0, 9, 6, 11],
        "text-transform": "uppercase",
        visibility: "none",
      },
      paint: {
