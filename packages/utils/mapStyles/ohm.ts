...
export const ohm: StyleSpecification = {
  ...
  layers: [
    ...
    },
    {
      ...
      minzoom: 6,
      maxzoom: 12,
      filter: ["in", ["get", "type"], ["literal", ["forest", "park", "wood"]]],
      layout: {
        visibility: "visible",
      },
      paint: {
    ...
    },
    {
      ...
      minzoom: 12,
      maxzoom: 24,
      filter: ["in", ["get", "type"], ["literal", ["forest", "wood", "scrub"]]],
      layout: {
        visibility: "visible",
      },
      paint: {
    ...
    },
    {
      ...
      filter: [
        ...
        [
          "literal",
          ["salt_pond", "glacier", "reservoir", "swimming_pool", "wetland"],
        ],
      ],
      layout: {
        visibility: "visible",
      ...
      filter: [
        ...
        [
          ...
          [
            "in",
            ["get", "type"],
            ["literal", ["traffic_signals", "pedestrian", "raceway"]],
          ],
        ],
        ["!", ["in", ["get", "type"], ["literal", ["highway"]]]],
      ],
      layout: {
        "icon-image": "{type}-18",
        visibility: "visible",
